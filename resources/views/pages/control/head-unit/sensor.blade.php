                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="grid grid-flow-row grid-cols-1 md:grid-cols-4">
                                    ...
                                    <div class="col-span-3">
                                        <div class="grid grid-flow-row grid-cols-2 gap-2">
                                            <div class="col-span-2">
                                                <input type="checkbox" name="phosphorus[enable]"
                                                    id="phosphorus-enable" class="rounded-md border-none"
                                                    value="1">
    ...
    @push('scripts')
        ...
        <script>
            ...
            const getSensor = async selenoidId => {
                ...
                document.querySelector('#hummidity-enable').checked = sensor?.humidity.enable ?? null
                document.querySelector('#hummidity-upper-limit').value = sensor?.humidity.upper_limit ?? null
                document.querySelector('#hummidity-lower-limit').value = sensor?.humidity.lower_limit ?? null

                document.querySelector('#nitrogen-enable').checked = sensor?.nitrogen.enable ?? null
                document.querySelector('#nitrogen-upper-limit').value = sensor?.nitrogen.upper_limit ?? null
                document.querySelector('#nitrogen-lower-limit').value = sensor?.nitrogen.lower_limit ?? null

                document.querySelector('#phosphorus-enable').checked = sensor?.phosphorus.enable ?? null
                document.querySelector('#phosphorus-upper-limit').value = sensor?.phosphorus.upper_limit ?? null
                document.querySelector('#phosphorus-lower-limit').value = sensor?.phosphorus.lower_limit ?? null

                document.querySelector('#kalium-enable').checked = sensor?.kalium.enable ?? null
                document.querySelector('#kalium-upper-limit').value = sensor?.kalium.upper_limit ?? null
                document.querySelector('#kalium-lower-limit').value = sensor?.kalium.lower_limit ?? null
