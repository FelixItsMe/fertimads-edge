          ...
          <div class="col-span-4 flex flex-col gap-2">
            ...
            <div class="grid grid-flow-row grid-cols-2 gap-8">
                  ...
                  <div class="col-span-3">
                    <div class="grid grid-flow-row grid-cols-2 gap-2">
                      <div class="col-span-2">
                        <input type="checkbox" name="hummidity[enable]" id="hummidity-enable" class="rounded-md border-none" value="1">
                        <label for="hummidity-enable" class="text-xs">Enable</label>
                      </div>
                      <input type="number" min="0" step=".01" name="hummidity[upper_limit]" class="bg-white rounded-md text-xs py-2 px-4 border-none" id="hummidity-upper-limit" placeholder="Upper Limit" aria-placeholder="Upper Limit">
                      <input type="number" min="0" step=".01" name="hummidity[lower_limit]" class="bg-white rounded-md text-xs py-2 px-4 border-none" id="hummidity-lower-limit" placeholder="Lower Limit" aria-placeholder="Lower Limit">
                    </div>
                  </div>
                </div>
                <div class="grid grid-flow-row grid-cols-4">
                  ...
                  <div class="col-span-3">
                    <div class="grid grid-flow-row grid-cols-2 gap-2">
                      <div class="col-span-2">
                        <input type="checkbox" name="nitrogen[enable]" id="nitrogen-enable" class="rounded-md border-none" value="1">
                        <label for="nitrogen-enable" class="text-xs">Enable</label>
                      </div>
                      <input type="number" min="0" step=".01" name="nitrogen[upper_limit]" class="bg-white rounded-md text-xs py-2 px-4 border-none" id="nitrogen-upper-limit" placeholder="Upper Limit" aria-placeholder="Upper Limit">
                      <input type="number" min="0" step=".01" name="nitrogen[lower_limit]" class="bg-white rounded-md text-xs py-2 px-4 border-none" id="nitrogen-lower-limit" placeholder="Lower Limit" aria-placeholder="Lower Limit">
                    </div>
                  </div>
                </div>
                <div class="grid grid-flow-row grid-cols-4">
                  ...
                  <div class="col-span-3">
                    <div class="grid grid-flow-row grid-cols-2 gap-2">
                      <div class="col-span-2">
                        <input type="checkbox" name="phosphorus[enable]" id="phosphorus-enable" class="rounded-md border-none" value="1">
                        <label for="phosphorus-enable" class="text-xs">Enable</label>
                      </div>
                      <input type="number" min="0" step=".01" name="phosphorus[upper_limit]" class="bg-white rounded-md text-xs py-2 px-4 border-none" id="phosphorus-upper-limit" placeholder="Upper Limit" aria-placeholder="Upper Limit">
                      <input type="number" min="0" step=".01" name="phosphorus[lower_limit]" class="bg-white rounded-md text-xs py-2 px-4 border-none" id="phosphorus-lower-limit" placeholder="Lower Limit" aria-placeholder="Lower Limit">
                    </div>
                  </div>
                </div>
                <div class="grid grid-flow-row grid-cols-4">
                  ...
                  <div class="col-span-3">
                    <div class="grid grid-flow-row grid-cols-2 gap-2">
                      <div class="col-span-2">
                        <input type="checkbox" name="kalium[enable]" id="kalium-enable" class="rounded-md border-none" value="1">
                        <label for="kalium-enable" class="text-xs">Enable</label>
                      </div>
                      <input type="number" min="0" step=".01" name="kalium[upper_limit]" class="bg-white rounded-md text-xs py-2 px-4 border-none" id="kalium-upper-limit" placeholder="Upper Limit" aria-placeholder="Upper Limit">
                      <input type="number" min="0" step=".01" name="kalium[lower_limit]" class="bg-white rounded-md text-xs py-2 px-4 border-none" id="kalium-lower-limit" placeholder="Lower Limit" aria-placeholder="Lower Limit">
                    </div>
                  </div>
                </div>
              </div>
              <div>
                <div class="flex flex-col gap-2">
                  <div>
                    <button type="button" onclick="storeSemiAuto()" class="bg-primary text-white font-bold rounded-md px-4 py-2">Kirim</button>
                  </div>
