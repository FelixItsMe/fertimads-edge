            ...
            <div class="grid grid-flow-row grid-cols-2 gap-8">
              <div class="flex flex-col gap-2">
                <div class="grid grid-flow-row grid-cols-4">
                  ...
                  <div class="col-span-3">
                    <div class="grid grid-flow-row grid-cols-2 gap-2">
                      <a href="{{ route('head-unit.schedule-water.index') }}" @class([ 'bg-white'=> !request()->routeIs('head-unit.schedule-water.index'),
                      ...
                      <a href="#" @class([ 'bg-white'=> !request()->routeIs('head-unit.schedule-fertilizer.index'),
                ...
                <div class="grid grid-flow-row grid-cols-4">
                  ...
                  <div class="col-span-3">
                    <div class="grid grid-flow-row grid-cols-2 gap-2">
                      ...
                      <div>
                        <input type="radio" id="type-{{ $fertilizerScheduleTypeEnum->value }}" name="type" value="{{ $fertilizerScheduleTypeEnum->value }}" class="hidden output-type peer/type" />
                        <label for="type-{{ $fertilizerScheduleTypeEnum->value }}" class="inline-flex w-full px-4 py-2 bg-white rounded-md text-xs cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked/type:text-blue-500 peer-checked/type:bg-primary peer-checked/type:text-white hover:text-gray-600 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                ...
                <div class="grid grid-flow-row grid-cols-4">
                  ...
                  <div class="col-span-3">
                    <div class="grid grid-flow-row grid-cols-2 gap-2" id="list-gardens">
                      <button type="button" class="bg-white rounded-md px-4 py-2 text-xs text-left" disabled>Pilih
                        Lahan</button>
                    </div>
                  </div>
                </div>
                <div class="grid grid-flow-row grid-cols-4">
                  ...
                  <div class="col-span-3">
                    <div class="grid grid-flow-row grid-cols-2 gap-2">
                      <input type="number" min="0" step=".01" name="volume" class="bg-white rounded-md text-xs py-2 px-4 border-none">
                    </div>
                  </div>
                </div>
                <div class="grid grid-flow-row grid-cols-4">
              ...
              <div>
                <div class="flex flex-col gap-2">
                  <div>
                    <button type="button" onclick="storeScheduleFertilize()" class="bg-primary text-white font-bold rounded-md px-4 py-2">Kirim</button>
                  </div>
