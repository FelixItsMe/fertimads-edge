                    ...
                    <div class="p-6 flex flex-col gap-2">
                        <div class="flex flex-col lg:flex-row max-sm:gap-2 lg:space-x-2">
                            <div class="w-full lg:w-1/2 flex-shrink">
                                ...
                                <x-text-input id="name" class="block mt-1 w-full rounded-xl" type="text"
                                    name="name" :value="$land->name" required autofocus autocomplete="name" />
                            ...
                            <div class="w-full lg:w-1/2 flex-shrink">
                                ...
                                <x-text-input id="area" class="block mt-1 w-full rounded-xl" type="number"
                                    min="0" step=".01"
                                    name="area" :value="$land->area" required autofocus autocomplete="area" />
                        ...
                        <div class="flex flex-col">
                            <div class="w-full">
                                ...
                                <x-textarea id="address" class="block mt-1 w-full rounded-xl" type="number"
                                    min="0" step=".01" name="address" required autofocus
                                    autocomplete="address">{{ $land->address }}</x-textarea>
                        ...
                        <div class="flex flex-col lg:flex-row max-sm:gap-2 lg:space-x-2">
                            <div class="w-full lg:w-1/3 flex-shrink">
                                ...
                                <x-text-input id="latitude" class="block mt-1 w-full rounded-xl" type="text"
                                    name="latitude" :value="$land->latitude" required autofocus autocomplete="latitude" />
                            ...
                            <div class="w-full lg:w-1/3 flex-shrink">
                                ...
                                <x-text-input id="longitude" class="block mt-1 w-full rounded-xl" type="text"
                                    name="longitude" :value="$land->longitude" required autofocus autocomplete="longitude" />
                            ...
                            <div class="w-full lg:w-1/3 flex-shrink">
                                ...
                                <x-text-input id="altitude" class="block mt-1 w-full rounded-xl" type="number"
                                    step=".01" name="altitude" :value="$land->altitude" required autofocus
