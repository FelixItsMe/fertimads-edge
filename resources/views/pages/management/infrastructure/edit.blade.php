      ...
      <h2 class="leading-tight">
          <ol class="breadcrumb">
              <li class="breadcrumb-item">
                  <a href="{{ route('infrastructure.index') }}">Manajemen Infrastruktur</a>
              </li>
              <li class="breadcrumb-item breadcrumb-active">{{ __('Edit Infrastruktur') }}</li>
          </ol>
      </h2>
  </x-slot>
                  ...
                  <div class="p-6 flex flex-col gap-2">
                      <div class="grid grid-flow-col sm:grid-flow-row sm:grid-cols-3 gap-2">
                          <div class="w-full">
                              ...
                              <img src="{{ asset($infrastructure->image ?? 'images/default/default-image.jpg') }}" alt="Preview Image"
                                  class="aspect-square object-cover w-full" id="preview-img">
                          </div>
                          <div class="w-full col-span-2">
                              <x-input-label for="image">{{ __('File Gambar') }} <span class="text-red-500">*Tidak wajib</span></x-input-label>
                      ...
                      <div class="flex flex-col">
                          <div class="w-full">
                              <x-input-label for="name">{{ __('Nama Infrastruktur') }}</x-input-label>
                              <x-text-input id="name" class="block mt-1 w-full rounded-xl" type="text"
                                  name="name" :value="$infrastructure->name" required autofocus autocomplete="name" />
                      ...
                      <div class="flex flex-col">
                          <div class="w-full">
                              ...
                              <x-text-input id="quantity" class="block mt-1 w-full rounded-xl" type="number"
                                  min="0"
                                  name="quantity" :value="$infrastructure->quantity" required autofocus autocomplete="quantity" />
                      ...
                      <div class="flex flex-col">
                          <div class="w-full">
                              ...
                              <x-textarea id="description" class="block mt-1 w-full rounded-xl" name="description" required autofocus
                                  autocomplete="description">{{ $infrastructure->description }}</x-textarea>
