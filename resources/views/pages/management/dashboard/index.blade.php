      ...
      <div class="grid grid-flow-row grid-cols-1 md:grid-cols-3 max-sm:gap-y-4 md:gap-4">
            ...
            <div class="grid grid-flow-row grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
              ...
              <div class="bg-white p-4 rounded-lg flex flex-col gap-2">
                <div class="text-sm font-semibold">Pemupukan
                  {{ $fertilizeSchedule->deviceSelenoid->garden->name }}
                </div>
        ...
        <div>
          <div class="bg-white rounded-lg p-10">
            <ol class="relative text-gray-500 border-s-2 border-gray-200 dark:border-gray-700 dark:text-gray-400 pb-2">
              @foreach ($activityLog as $activity)
              <li class="mb-10 ms-6">
                <span class="absolute flex items-center justify-center w-8 h-8 bg-white rounded-full -start-4 ring-4 ring-white dark:ring-gray-900 dark:bg-green-900">
