  ...
  <x-slot name="header">
      <h2 class="leading-tight">
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item breadcrumb-active">{{ __('Edit Perangkat Portable SMS') }}</li>
          </ol>
      </h2>
  </x-slot>
  ...
  <div class="py-12">
      <div class="sm:max-w-7x xl:max-w-full mx-auto sm:px-6 lg:px-8">
          <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
              <form action="{{ route('portable-device.update', $portableDevice->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <div class="p-6 flex flex-col gap-2">
                      <div class="grid grid-flow-col sm:grid-flow-row sm:grid-cols-5 gap-2">
                          <div class="w-full">
                              ...
                              <img src="{{ asset($portableDevice->image ?? 'images/default/default-image.jpg') }}" alt="Preview Image"
                      ...
                      <div class="grid grid-cols-1 lg:grid-cols-2 gap-2">
                          <div class="w-full">
                              ...
                              <x-text-input id="series" class="block mt-1 w-full rounded-xl" type="text"
                                  name="series" :value="$portableDevice->series" required autofocus autocomplete="series" />
                          ...
                          <div class="w-full">
                              ...
                              <x-text-input id="version" class="block mt-1 w-full rounded-xl" type="text"
                                  name="version" :value="$portableDevice->version" required autofocus autocomplete="version"
                      ...
                      <div class="w-full">
                          ...
                          <x-text-input id="production-date" class="block mt-1 w-full rounded-xl" type="date"
                              name="production_date" :value="$portableDevice->production_date" required autofocus
                      ...
                      <div class="flex flex-col">
                          <div class="w-full">
                              ...
                              <x-textarea id="note" class="block mt-1 w-full rounded-xl"
                                  name="note">{{ $portableDevice->note }}</x-textarea>
