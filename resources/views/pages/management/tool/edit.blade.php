  ...
  <x-slot name="header">
      <h2 class="leading-tight">
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item breadcrumb-active">{{ __('Edit Alat') }}</li>
          </ol>
      </h2>
  </x-slot>
                  ...
                  <div class="p-6 flex flex-col gap-2">
                      <div class="grid grid-flow-col sm:grid-flow-row sm:grid-cols-3 gap-2">
                          <div class="w-full">
                              ...
                              <img src="{{ asset($tool->image ?? 'images/default/default-image.jpg') }}" alt="Preview Image"
                      ...
                      <div class="flex flex-col">
                          <div class="w-full">
                              ...
                              <x-text-input id="quantity" class="block mt-1 w-full rounded-xl" type="number"
                                  min="0"
                                  name="quantity" :value="$tool->quantity" required autofocus autocomplete="quantity" />
                      ...
                      <div class="flex flex-col">
                          <div class="w-full">
                              ...
                              <x-textarea id="description" class="block mt-1 w-full rounded-xl" name="description" required autofocus
                                  autocomplete="description">{{ $tool->description }}</x-textarea>
