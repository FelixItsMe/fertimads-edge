<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="leading-tight">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item breadcrumb-active">{{ __('Tambah Jalur Pipa Air Baru') }}</li>
            </ol>
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="sm:max-w-7x xl:max-w-full mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('water-pipeline.store') }}" method="POST">
                @csrf
                    ...
                    <div class="w-full">
                        <div class="p-6 bg-white overflow-hidden shadow-sm sm:rounded-lg flex flex-col gap-y-4">
                            ...
                            <div class="w-full">
                              ...
                              <x-textarea id="description" class="block mt-1 w-full rounded-xl" type="number" min="0" step=".01" name="description" required autofocus autocomplete="description">{{ old('description') }}</x-textarea>
    ...
    @push('scripts')
        ...
        <script>
            ...
            map.on(L.Draw.Event.CREATED, function(e) {
                ...
                document.querySelector('#polyline').value = JSON.stringify(stateData.polyline.map((val, _) => [val.lat, val.lng]))
