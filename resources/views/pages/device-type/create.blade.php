    ...
    <x-slot name="header">
        <h2 class="leading-tight">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item breadcrumb-active">{{ __('Tambah Tipe Perangkat IoT Baru') }}</li>
            </ol>
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="sm:max-w-7x xl:max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('device-type.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="p-6 flex flex-col gap-2">
                        ...
                        <div class="flex flex-col">
                            <div class="w-full">
                                ...
                                <x-textarea id="description" class="block mt-1 w-full rounded-xl" name="description">{{ old('description') }}</x-textarea>
