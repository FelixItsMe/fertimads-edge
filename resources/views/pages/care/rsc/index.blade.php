                  ...
                  <div class="mt-2">
                    ...
                    <div class="mt-4">
                      <div class="flex space-x-4">
                        <div class="w-2/5">
                          <h4 class="text-base font-medium leading-6 text-gray-900 mb-2">Opsi Kendali</h4>
                          <div class="flex flex-col space-y-3">
                            <button type="button" class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-white bg-teal-300 border border-transparent rounded-md shadow-sm hover:bg-teal-700 hover:text-white w-full text-xs">Manual</button>
                            <button type="button" class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-black bg-gray-100 border border-transparent rounded-md shadow-sm hover:bg-teal-700 hover:text-white w-full text-xs">Jadwal</button>
                            <button type="button" class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-black bg-gray-100 border border-transparent rounded-md shadow-sm hover:bg-teal-700 hover:text-white w-full text-xs">Otomatis</button>
                          </div>
                        </div>
                        <div class="w-3/5">
                          <div class="flex items-center justify-between mb-2">
                            <h4 class="text-base font-medium leading-6 text-gray-900">Kendali Perangkat</h4>
                            <span class="font-bold text-gray-600">Durasi: <span class="font-normal">4,3 Menit</span></span>
                          </div>
                          <div class="flex items-center space-x-3 mb-3 w-full">
                            <h4 class="text-base leading-6 text-gray-900 w-full">Pilih Output</h4>
                            <button type="button" class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-white bg-teal-300 border border-transparent rounded-md shadow-sm hover:bg-teal-700 hover:text-white w-full text-xs">Penyiraman</button>
                            <button type="button" class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-black bg-gray-100 border border-transparent rounded-md shadow-sm hover:bg-teal-700 hover:text-white w-full text-xs">Pemupukan</button>
                          </div>
                          <div class="flex items-center space-x-3 mb-3 w-full">
                            <h4 class="text-base leading-6 text-gray-900 w-full">Atur Volume</h4>
                            <button type="button" class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-white bg-teal-300 border border-transparent rounded-md shadow-sm hover:bg-teal-700 hover:text-white w-full text-xs">Penyiraman</button>
                            <button type="button" class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-black bg-gray-100 border border-transparent rounded-md shadow-sm hover:bg-teal-700 hover:text-white w-full text-xs">Pemupukan</button>
                          </div>
                        </div>
        ...
        land.gardens.forEach(garden => {
          ...
          gardenLayer.on('click', () => {
            ...
            const generateCalendar = (month, year) => {
              ...
              $(document).find("#month-year-text").text(`${currentMonthName} ${year}`)
              ...
              while (currentDay <= daysInMonth) {
                ...
                for (let i = 0; i < 7; i++) {
                  ...
                  cell.classList.add('py-2', 'border', 'text-center', 'relative', 'cursor-pointer', 'hover:bg-primary',
                    'hover:text-white');
              ...
              calendarEl.empty() // Clear previous calendar
            ...
            $(document).on('click', '#subMonthButton', function(e) {
              currentMonth--
              if (currentMonth < 0) {
                currentMonth = 11
                currentYear--
