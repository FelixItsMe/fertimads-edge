<x-app-layout>
  ...
  <div class="py-12">
    <div class="sm:max-w-7x xl:max-w-full mx-auto sm:px-6 lg:px-8">
      <div class="grid grid-flow-row grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-4">
        <x-card-info>
          <h5 class="text-xs text-slate-400">Total Penyakit Terdata</h5>
          <span class="font-bold">{{ $diseaseCount }}</span>
        </x-card-info>
        <x-card-info>
          <h5 class="text-xs text-slate-400">Total Hama Terdata</h5>
          <span class="font-bold">{{ $pestCount }}</span>
        </x-card-info>
        <x-card-info>
          <h5 class="text-xs text-slate-400">Total Gulma Terdata</h5>
          <span class="font-bold">{{ $weedsCount }}</span>
        </x-card-info>
        <x-card-info>
          <h5 class="text-xs text-slate-400">Total Laporan Pemupukan</h5>
          <span class="font-bold">{{ $fertilizerCount }}</span>
        </x-card-info>
      </div>
