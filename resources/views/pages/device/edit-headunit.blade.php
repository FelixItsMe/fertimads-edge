                    ...
                    <div class="p-6 flex flex-col gap-2">
                        <div class="grid grid-flow-col sm:grid-flow-row sm:grid-cols-4 gap-2">
                            <div class="w-full">
                                ...
                                <img src="{{ asset($device->image ?? 'images/default/default-image.jpg') }}"
                                    alt="Preview Image" class="aspect-square object-cover w-full" id="preview-img">
                            </div>
                        ...
                        <div class="flex flex-col">
                            <div class="w-full">
                                ...
                                <x-text-input id="type" class="block mt-1 w-full rounded-xl bg-slate-300"
                                    type="text" :value="$device->deviceType->type->getLabelText()" required autofocus autocomplete="type" disabled />
                            </div>
                        </div>
                        <div class="flex flex-col">
                            <div class="w-full">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="latitude" class="block mt-1 w-full rounded-xl" type="text"
                                    name="latitude" :value="$device->latitude" autocomplete="latitude" />
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="longitude" class="block mt-1 w-full rounded-xl" type="text"
                                    name="longitude" :value="$device->longitude" autocomplete="longitude" />
                        ...
                        <div class="flex flex-col">
                            <div class="w-full">
                                ...
                                <x-textarea id="note" class="block mt-1 w-full rounded-xl"
                                    name="note">{{ $device->note }}</x-textarea>
    ...
    @push('scripts')
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", () => {
                ...
                map.panTo([stateData.latitude, stateData.longitude], 18)
                editableLayers.addLayer(currentMarkerLayer);
            })
        </script>
    @endpush
