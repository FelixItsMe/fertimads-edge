                ...
                <div class="p-3 flex max-md:flex-col max-md:space-y-2 justify-between items-center">
                    ...
                    <div class="flex flex-row space-x-2">
                        <a href="{{ route('garden.create') }}"
                            class="bg-fertimads-2 text-white py-2 px-4 rounded-md">Tambah Kebun</a>
                        ...
                        <tbody class="table-border-bottom-0">
                            @forelse ($gardens as $garden)
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex flex-row space-x-2">
                                            <a href="{{ route('garden.show', $garden->id) }}" title="Detail Kebun"
                                                class="text-sm text-info">
                                                <i class="fa-solid fa-circle-info"></i>
                                            </a>
                                            <a href="{{ route('garden.edit', $garden->id) }}" title="Edit Kebun"
