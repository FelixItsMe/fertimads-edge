<x-guest-layout>
  ...
  <form method="POST" action="{{ route('login') }}">
    ...
    <div>
      ...
      <x-text-input id="email" class="block mt-1 px-5 w-full rounded-xl" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="mail@simmmple.com" aria-placeholder="mail@simmmple.com" />
    ...
    <div class="mt-4">
      ...
      <x-text-input id="password" class="block mt-1 px-5 w-full rounded-xl" type="password" name="password" placeholder="Min. 8 characters" aria-placeholder="Min. 8 characters" required autocomplete="current-password" />
